        ...
        <>
            <div className='flex h-screen'>
                ...
                <div className="flex flex-col items-start space-y-6 mt-32 ml-20 w-[55%] ">
                    <h1 className="text-white text-7xl font-bold">Email</h1>
                    <h2 className="text-white text-3xl font-bold">Make email impactful and Professional. </h2>
                ...
                {/* photos */}
                <div className='mt-10'>
                    <img src="/images/wimg1.webp" alt="whatsapp_image" />
                </div>
