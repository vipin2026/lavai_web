        ...
        <>
            <div className='flex h-screen'>
                ...
                <div className="flex flex-col items-start space-y-6 mt-32 ml-20 w-[55%] ">
                    <h1 className="text-white text-7xl font-bold">LinkedIn Marketing</h1>
                    <h2 className="text-white text-2xl ">Engaging content that resonates with your target audience, boosting engagement. Creating a linkedin and posting is not enough in today's market. With LAVAI increase your Campaign reach and enhance your business image. </h2>
