    ...
    return (
        <>
            <div className='flex h-screen '>
                ...
                {/* heading */}
                <div className="flex flex-col items-start space-y-6 p-2 mt-32 ml-20 w-[55%]">
                    <h1 className="text-white text-7xl font-bold">Journey Orchestration</h1>
                    <h2 className="text-white text-2xl">Craft impactful marketing journeys that generate leads, elevate brand presence, and deliver personalized, data-driven experiences across all channels with our full suite of marketing solutions.</h2>
                ...
                {/* photos */}
                <div className='mt-10'>
                    <img src="/images/wimg1.webp" alt="orchestration_image" />
                </div>
