        ...
        <>
            <div className='flex h-screen'>
                ...
                <div className="flex flex-col items-start space-y-6 mt-32 ml-20 w-[55%] ">
                    <h1 className="text-white text-7xl font-bold">SEO Optimization</h1>
                    <h2 className="text-white text-2xl ">Techniques to improve your website's visibility on search engines, driving organic traffic and increasing brand awareness.
                    </h2>
