        ...
        <>
            <div className='flex h-screen'>
                ...
                <div className="flex flex-col items-start space-y-6 mt-32 ml-20 w-[55%] ">
                    <h1 className="text-white text-7xl font-bold">Webinars</h1>
                    <h2 className="text-white text-2xl ">Specialists to help your organizations attract more clients through expertly curated events. the team of marketing professionals that work collaboratively to showcase your unique strengths, connecting you with potential clients and enhancing your business opportunities. </h2>
