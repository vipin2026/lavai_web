...
export default function Lavai(){
    return(
        ...
        <div className="relative z-10 p-8 rounded-lg bg-white bg-opacity-20 shadow-lg backdrop-blur-lg max-w-4xl text-center transform hover:scale-105 transition-transform duration-500 ease-in-out">
          <h1 className="text-5xl font-extrabold mb-4 text-white drop-shadow-lg animate-pulse">Why Choose LAVAI?</h1>
          ...
          <p className="text-lg mb-6 leading-relaxed text-white animate-fadeIn">
          With a proven track record of success, LAVAI is committed to helping you achieve your marketing objectives. Whether you are looking to enhance your social media presence, improve your SEO rankings, generate quality leads, engage clients through webinars, or reach audiences via SMS and WhatsApp, we have the expertise and resources to elevate your brand.
          </p>
          <div className="mt-6">
